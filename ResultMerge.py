...
if __name__ == '__main__':
    srcpath = r'/home/fuyongkang/DCR/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/val/test_results_by_class'
    dstpath = r'../DCR/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/val/merge_results'
    srcpath = r'/home/fuyongkang/DCR/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/test/test_results_by_class'
    dstpath = r'../DCR/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/test/merge_results'
    srcpath = r'../DCR/output/rcnn/DOTA_rrpn_v1/DOTA_rrpn_v1/val/test_results_by_class'
    dstpath = r'../DCR/output/rcnn/DOTA_rrpn_v1/DOTA_rrpn_v1/val/merge_results'
    mergebypoly(srcpath, dstpath)
    # mergebyrec()
