...
def main():
    ...
    # fyk
    detpath = r'../DCR/output/rcnn/DOTA_quadrangle/DOTA_quadrangle/val/merge_results/Task1_{:s}.txt'
    detpath = r'../DCR/output/rcnn/DOTA_rrpn_v1/DOTA_rrpn_v1/val/merge_results/Task1_{:s}.txt'
    ...
    imagesetfile = r'../DOTA/valset.txt'
